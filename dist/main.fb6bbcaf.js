...
function fetchAnimals(e) {
  ...
  if (!(0, _verify.isTrueZip)(zip)) {
    (0, _verify.showAlert)("Please enter a valid zip code.", "warning");
    return;
  } // Fetch Pets


  (0, _fetchJsonp.default)("https://api.petfinder.com/pet.find?format=json&key=8cdeeb4f8b12fbdd8a7d34eca794a821&animal=".concat(animal, "&location=").concat(zip, "&sex=").concat(sex, "&callback=callback"), {
